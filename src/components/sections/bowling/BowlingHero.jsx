      ...
      <div className="relative mx-auto max-w-7xl text-center">
        <Reveal>
          ...
          <h1 className="mb-6 text-4xl md:text-6xl">
            Diversión, competencia y buenos momentos
          </h1>

          <p className="mx-auto max-w-3xl text-lg text-zinc-300 md:text-xl">
            Viví la experiencia del bowling en Bowling Club Gimnasia con un ambiente ideal
            para amigos, pareja, familia o celebraciones especiales.
          </p>
        </Reveal>
      </div>
    </section>
