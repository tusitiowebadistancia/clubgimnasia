...
export default function ServicesPreview() {
  return (
    <section className="bg-white/[0.03] py-20 px-4 backdrop-blur-[2px]">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <Reveal>
            <div className="rounded-2xl border border-white/10 bg-zinc-900/65 p-6 text-center backdrop-blur-sm transition hover:scale-105">
