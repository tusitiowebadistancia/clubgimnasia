...
export default function JuegosHero() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl text-center">
        <Reveal>
          ...
          <h1 className="mb-6 text-4xl md:text-6xl">
            Más formas de disfrutar el club
          </h1>

          <p className="mx-auto max-w-3xl text-lg text-zinc-300 md:text-xl">
            Accedé a juegos, dinámicas y recursos útiles relacionados con la
            experiencia del club, organizados para crecer de forma clara y escalable.
          </p>
        </Reveal>
      </div>
    </section>
