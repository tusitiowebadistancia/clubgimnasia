      ...
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-zinc-400">
           ...
           {/* <li><Link to="/promociones" className="transition hover:text-white">Promociones</Link></li>*/}
            ...
            <li><Link to="/juegos" className="transition hover:text-white">Juegos</Link></li>
            <li><Link to="/menu" className="transition hover:text-white">Menú</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-zinc-400">
            <li>Calle 67 3049, Necochea, Buenos Aires</li>
            <li>WhatsApp: 2262 58-9377</li>
            <li>Horario: 19:30hs a 03:00</li>
            <li>
              <a
        ...
        <div>
          ...
          <a
            href="https://wa.me/542262589377?text=Hola%2C%20quiero%20consultar%20por%20reservas%20en%20Bowling%20Club%20Gimnasia."
            target="_blank"
            rel="noreferrer"
