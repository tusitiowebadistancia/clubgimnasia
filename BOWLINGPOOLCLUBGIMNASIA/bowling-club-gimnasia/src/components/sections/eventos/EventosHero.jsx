      ...
      <div className="relative mx-auto max-w-7xl text-center">
        <Reveal>
          ...
          <h1 className="mb-6 text-4xl md:text-6xl">
            Cumpleaños, reuniones y momentos para recordar
          </h1>

          <p className="mx-auto max-w-3xl text-lg text-zinc-300 md:text-xl">
  Consultá por cumpleaños, reuniones y celebraciones en Bowling Club Gimnasia y armá una experiencia distinta en Necochea.
</p>
        </Reveal>
      </div>
    </section>
